...
export default function Singular() {
    return(
        <motion.div style={{width:"418px", height:"418px",borderRadius:"50%", justifyContent:"center"}}>
            <motion.div animate={{rotate:360, scale:[1, 0.8, 0.6, 0.6,0.8,1]}} transition={{duration:Infinity}} style={{height:"410px",width:"410px", borderRadius:"50%", border:"4px solid rgba(1, 46, 64, 1)", justifyContent:"center"}}>
